...
export const jobs: Job[] = [
     ...
     {
          jobTitle: {
               en: "Principal Fullstack Developer & Junior Researcher",
               es: "Desarrollador Fullstack Principal & Investigador Junior",
          ...
          description: {
               ...
               fr: "Responsable de fournir des services spécialisés en développement et déploiement web, garantissant une expérience utilisateur optimale et des performances efficaces. J'ai développé une plateforme web moderne et fonctionnelle, gérant à la fois le frontend et le backend. De plus, j'ai effectué des tests approfondis et fourni une documentation détaillée pour garantir le succès du projet."
          },
          startDate: {
               en: "January 2023",
               es: "Enero 2023",
          ...
          evidence: "https://drive.google.com/file/d/1ejHOfMnppX3tMo1Dp6cSsCx_zDIolU0_/view?usp=sharing"
          
     },

     {
          jobTitle:{
               en: "Software Developer & Research Assistant",
               es: "Desarrollador de Software & Asistente de Investigación",
          ...
          description:{
               ...
               fr : "J'ai été chargé de soutenir des projets de recherche liés au logiciel, en apportant une expertise à la fois en design graphique et en implémentation de l'interface utilisateur (UI) et de l'expérience utilisateur (UX). J'ai collaboré étroitement avec l'équipe pour assurer l'intégration transparente des éléments de design dans le processus de développement du projet."
          },
          startDate:{
               en: "January 2022",
               es: "Enero 2022",
